...
import com.kaleido.repository.ActivityRepository;
import com.kaleido.repository.search.ActivitySearchRepository;
...
/**
 * REST controller for managing {@link com.kaleido.domain.Activity}.
 */
@RestController
@RequestMapping("/api")
@Transactional
